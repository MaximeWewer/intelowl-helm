...
![Version: 6.5.1](https://img.shields.io/badge/Version-6.5.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v6.5.1](https://img.shields.io/badge/AppVersion-v6.5.1-informational?style=flat-square)
...
| nginx.service.nodePort | string | `nil` | NodePort port number (only used when type is NodePort) |
...
| flower.service.nodePort | string | `nil` | NodePort port number (only used when type is NodePort) |
